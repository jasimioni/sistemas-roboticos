# Ande com o robô pelo ambiente coletando as informações do
# LiDAR convertidas para a referência Odom.
# Apresente estes pontos. Se a conversão estiver correta, você verá
# o mapa por todo local onde o robô navegou
